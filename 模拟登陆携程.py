...
logurl='https://accounts.ctrip.com/member/login.aspx?BackUrl=http%3A%2F%2Fwww.ctrip.com%2F%3Futm_source%3Dbaidu%26utm_medium%3Dcpc%26utm_campaign%3Dbaidu81%26campaign%3DCHNbaidu81%26adid%3Dindex%26gclid%3D%26isctrip%3DT&responsemethod=get'
driver.get(logurl)
time.sleep(1)
driver.find_element_by_id('domUser').click()
time.sleep(1)
driver.find_element_by_id('txtUserName').send_keys('18537006082')
time.sleep(1)
driver.find_element_by_id('txtPwd').send_keys('Chang1017')
time.sleep(1)
try:
